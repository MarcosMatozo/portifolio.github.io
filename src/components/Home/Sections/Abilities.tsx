...
export default function Abilities(){
    return(
        ...
        <div className="container-section abilities">
            ...
            <div className="totalCentered banner totalCentered myself ">
            ...
            <div className="totalCentered">
                ...
                >
                    ...
                    <li className="glide__slide">
                        <div className="inner">
                        <svg viewBox="0 0 87 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="totalCentered description">
                <p>Atuei bastante em projetos de e-commerce como desenvolvedor front-end, e a partir de 2022, virei líder da equipe e fiquei atuando mais na gestão do que nos códigos em si, mas isso não tirou de mim o prazer de desenvolver de olhar para as tecnologias, embora o tempo para poder "brincar" com os desenvolvimentos ter se tornado menor.</p>
            </div>
            ...
            <div className="totalCentered indicators">
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>
                            <span className='name' >Shopfy</span>
                            <span className='level l40' >
                                <span>40</span>
                            </span>
                        </li>
                        <li>
